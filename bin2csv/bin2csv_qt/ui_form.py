...
class Ui_bin2csv_qt(object):
    def setupUi(self, bin2csv_qt):
        ...
        self.lineEditInputDir.setGeometry(QRect(6, 40, 621, 25))
        ...
        self.pushButtonInputDirBrowse.setGeometry(QRect(640, 40, 88, 25))
        ...
        self.pushButtonOutputFileBrowse.setGeometry(QRect(640, 110, 88, 25))
        self.lineEditOutputFile = QLineEdit(bin2csv_qt)
        self.lineEditOutputFile.setObjectName(u"lineEditOutputFile")
        self.lineEditOutputFile.setGeometry(QRect(6, 110, 621, 25))
        ...
        self.pushButtonConvert.setGeometry(QRect(7, 160, 721, 31))
        ...
        self.textEditConversionProgress.setGeometry(QRect(8, 209, 721, 171))
