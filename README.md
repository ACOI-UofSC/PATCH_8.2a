...
any time lag in the RTC. Sending a 's:MM-DD-YYYY-HH-MM-SS' where MM is month, DD is day, YYYY is year, HH is hour (24 hour clock), MM is minute and SS is second will set the RTCs
